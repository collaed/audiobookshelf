                ...
                <div class="grow px-2">
                  <div class="flex items-center">
                    <div class="flex" @click.stop>
                      <NuxtLink :to="`/item/${episode.libraryItemId}`" class="text-sm text-gray-200 hover:underline">{{ episode.podcast.metadata.title }}</NuxtLink>
                    </div>
...
export default {
  ...
  methods: {
    async toggleEpisodeFinished(episode, confirmed = false) {
      ...
      this.episodesProcessingMap[episode.id] = true
      ...
      this.$axios
        ...
        .finally(() => {
          this.episodesProcessingMap[episode.id] = false
        })
    },
