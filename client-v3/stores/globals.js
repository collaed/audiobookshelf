export const state = () => ({
  ...
  dateFormats: [
    ...
    { text: 'MMM do, yyyy', value: 'MMM do, yyyy' },
    { text: 'MMMM do, yyyy', value: 'MMMM do, yyyy' },
    { text: 'dd MMM yyyy', value: 'dd MMM yyyy' },
    { text: 'dd MMMM yyyy', value: 'dd MMMM yyyy' }
  ],
  timeFormats: [
    { text: 'h:mma (am/pm)', value: 'h:mma' },
    { text: 'HH:mm (24-hour)', value: 'HH:mm' }
  ],
  podcastTypes: [
...
export const getters = {
  getLibraryItemCoverSrc:
    ...
    (libraryItem, placeholder = null, raw = false) => {
      ...
      const libraryItemId = libraryItem.libraryItemId || libraryItem.id
