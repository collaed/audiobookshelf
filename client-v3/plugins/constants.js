...
export default defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.config.globalProperties.$constants = Constants
  nuxtApp.vueApp.config.globalProperties.$keynames = KeyNames
  nuxtApp.vueApp.config.globalProperties.$hotkeys = Hotkeys
})
